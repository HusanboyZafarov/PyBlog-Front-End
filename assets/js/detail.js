...
let detail_save = document.querySelectorAll(".detail-save")

detail_save.forEach((element) => {
    innerchild = element.firstElementChild
    element.addEventListener("click", () => {
        innerchild.classList.toggle("fa-solid")
        innerchild.classList.toggle("fa-regular")
    })
});